...
},{}],"js/modules/letters.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default() {
  var splittingTitle = _toConsumableArray(document.querySelectorAll('.anim-splitting-title'));

  var splittingText = _toConsumableArray(document.querySelectorAll('.anim-splitting-text'));

  var tlTitle = _gsap.default.timeline();

  var tlText = _gsap.default.timeline();

  [].concat(_toConsumableArray(splittingTitle), _toConsumableArray(splittingText)).forEach(function (letters) {
  ...
  _gsap.default.set('.anim-splitting-title', {
    perspective: 400
  });

  _gsap.default.defaults({
    ease: 'back'
  });
...
},{"gsap":"../node_modules/gsap/index.js","splitting":"../node_modules/splitting/dist/splitting.js"}],"js/modules/header.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default() {
  ...
  _gsap.default.from('.anim-fade-scale-up', {
    duration: 0.8,
    opacity: 0,
    scale: 0,
    y: 80
  ...
  _gsap.default.from('.anim-fade-left', {
    duration: 0.8,
    opacity: 0,
    x: '100%'
  });
...
var _letters = _interopRequireDefault(require("./modules/letters"));
...
},{"./modules/letters":"js/modules/letters.js","./modules/header":"js/modules/header.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2484" + '/');
